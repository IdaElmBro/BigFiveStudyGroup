...
PitchMeta <- PitchVari %>% 
  select(Article, SAMPLE_SIZE_SZ, SAMPLE_SIZE_HC, PITCH_F0SD_SZ_M, PITCH_F0SD_HC_M, PITCH_F0SD_SZ_SD, PITCH_F0SD_HC_SD, yi, vi)

PitchMeta <- PitchMeta %>% 
  dplyr::rename("StudyEffect" = yi, "ObservedSigma" = vi)
