...
p1 <- pp_check(MLU_f1_prior_samp, ndraws = 100) +ggtitle('Model 1 Prior-predictive check') + xlim(0, 10)
p2 <- pp_check(MLU_f2_prior_samp, ndraws = 100) +ggtitle('Model 2 Prior-predictive check') + xlim(0, 10)
p3 <- pp_check(MLU_f3_prior_samp, ndraws = 100) + ggtitle('Model 3 Prior-predictive check') + xlim(0, 10)
...
p1 <- pp_check(MLU_model1_posterior, ndraws = 100)+ ggtitle('Model 1 Posterior-predictive check') + xlim(0, 25)
p2 <- pp_check(MLU_model2_posterior , ndraws = 100)+ ggtitle('Model 2 Posterior-predictive check') + xlim(0, 25)
p3 <- pp_check(MLU_model3_posterior, ndraws = 100) + ggtitle('Model 3 Posterior-predictive check') + xlim(0, 25)
grid.arrange(p1,p2,p3)
...
p1 <- ggplot(d,aes(x = ID, y =looic1,
             color = Diag)) + geom_point() + theme_bw() +ggtitle('Model 1')
p2 <- ggplot(d,aes(x = ID, y =looic2,
             color = Diag)) + geom_point() + theme_bw()+ggtitle('Model 2')
p3 <- ggplot(d,aes(x = ID, y =looic3,
             color = Diag)) + geom_point() + theme_bw()+ggtitle('Model 3')
